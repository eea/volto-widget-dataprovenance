pipeline {
  ...
  environment {
        ...
        NAMESPACE = "@eeacms"
        SONARQUBE_TAGS = "volto.eea.europa.eu,clmsdemo.devel6cph.eea.europa.eu,forest.eea.europa.eu,demo-www.eea.europa.eu,circularity.eea.europa.eu,www.eea.europa.eu-ims,biodiversity.europa.eu,prod-www.eea.europa.eu,water.europa.eu-marine,demo-kitkat.dev2aws.eea.europa.eu,climate-adapt.eea.europa.eu"
        DEPENDENCIES = ""
        VOLTO = "alpha"
    }
